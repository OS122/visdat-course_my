...
class Fenster(QMainWindow):
    ...
    def open_file(self):
            ...
            filename, _ = QFileDialog.getOpenFileName(
                ...
                myos.path.join(myos.path.dirname(__file__), "data_2"),
    ...
    def show_noise(self):
        try:
            ...
            self.statusBar().showMessage(
                f"Rauschen: fs={fs}Hz, T1={T1}s, T2={T2}s, T3={T3}s, dt={dt}s",
                4000
            )

            print("Rauschparameter:")
            print(f"fs={fs}, T1={T1}, T2={T2}, T3={T3}, dt={dt}")
            ...
            self.statusBar().showMessage(
                "Fehler: Ungültige Eingabe bei Rauschparametern",
                5000
            )


    def run_simulation(self):
        self.statusBar().showMessage("Simulation läuft", 3000)
        print("Simulation durchführen")
